            ...
            if (isWhiteListedforPhase1 ) {
                return (
                    <>
                        <div style={{
                            fontSize: "1em",                           
                        }} className="pl-4 pr-4 bg-gradient-to-br from-brand-green to-brand-blue bg-clip-text text-transparent  flex items-center justify-center text-brand-background hover:shadow-lg bg-white font-bold rounded-md">Congratulation! You are in WL Phase 1 Free Mint. You can Mint on 09 Dec 2022 from 6am to 6pm. </div>
                    </>
                )
            }
            else if (isWhiteListedforPhase2) {
                return (
                    <>
                        <div style={{
                            fontSize: "1em",                           
                        }} className="pl-4 pr-4  bg-gradient-to-br from-brand-green to-brand-blue bg-clip-text text-transparent   flex items-center justify-center text-brand-background hover:shadow-lg bg-white font-bold rounded-md">Congratulation! You are in WL Phase 2 Free Mint. You can Mint on 09 Dec 2022 from 6pm to 10 Dec 2022  6pm.</div>
                    </>
                )
            }
            else {
